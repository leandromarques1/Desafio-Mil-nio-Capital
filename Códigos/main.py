...
if __name__ == '__main__':
	...
	print("Como o indexador da Operação é PRE, ele NÂO possui atrelado a ele Incorporação de Juros")
	print("PU Operacao:",PU_Par(valorAtualizado, taxa_juros, numDiasUteis))
