...
if __name__ == '__main__':
	...
	print("Calcular a taxa dado um determinado PU de Operação")
	#precoOperacao = float(input("Digite um PU de Operação p/ a análise: "))
	#precoOperacao = 1070.115126352718
	#precoOperacao = 1070.1151263
	#precoOperacao = 1070.115
	#precoOperacao = 1070
	precoOperacao = 1000
	#print("Taxa de Operacao:",)
	print("Aguarde enquanto processamos o cálculo (no maximo, 15 seg)...")
	print("Taxa de juros da operacao: ", taxa_OPER(precoOperacao, dataCalculo, dadosContrato),"%")
			
	#taxa_OPER(precoOperacao, dataCalculo, dadosContrato)
	''''''